import data from "@/content/courses/fundamentals-uas/knowledge-map.v0.3.json";
import { topics } from "./catalog";
import { academicSource } from "./foundation";
...
export interface GraphEdge {id:string;sourceId:string;targetId:string;relationType:string;provenance:string;sourceRef:string;rationale:string}
