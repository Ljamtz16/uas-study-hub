import graph from "@/content/courses/fundamentals-uas/knowledge-map.v0.3.1.json";
import { canonicalBlocks, canonicalTopics, canonicalObjectives } from "./foundation";
...
export const courses:Course[]=[{id:FUNDAMENTALS_COURSE_ID,title:"Fundamentos de Sistemas Aéreos No Tripulados",order:1,ects:6,description:"Currículo oficial USC 2026/2027 · material técnico pendiente del Campus Virtual."}];
...
export const blocks:Block[]=[...canonicalBlocks,...legacyBlocks];
